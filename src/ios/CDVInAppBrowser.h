...
// Added 7-31-14 New toolbar button
@property (nonatomic, strong) IBOutlet UIBarButtonItem* toolbarButton;
...
// Added 7-31-14 New function to create a new toolbar button with a different label
